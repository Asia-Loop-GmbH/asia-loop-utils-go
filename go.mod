...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/cognitoidentityprovider v1.34.3
	github.com/aws/aws-sdk-go-v2/service/sns v1.28.2
	github.com/nam-truong-le/lambda-utils-go/v4 v4.1.234
...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/secretsmanager v1.27.2 // indirect
	github.com/aws/aws-sdk-go-v2/service/ssm v1.47.1 // indirect
