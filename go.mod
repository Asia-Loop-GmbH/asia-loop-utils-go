...
require (
	...
	github.com/nam-truong-le/lambda-utils-go/v4 v4.1.235
...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/secretsmanager v1.27.3 // indirect
	github.com/aws/aws-sdk-go-v2/service/ssm v1.48.0 // indirect
