...
require (
	...
	github.com/adyen/adyen-go-api-library/v8 v8.0.0
	...
	github.com/nam-truong-le/lambda-utils-go/v4 v4.1.175
...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/secretsmanager v1.24.0 // indirect
