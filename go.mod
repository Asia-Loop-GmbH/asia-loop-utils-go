...
require (
	...
	github.com/nam-truong-le/lambda-utils-go/v4 v4.2.35
...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/secretsmanager v1.34.1 // indirect
	github.com/aws/aws-sdk-go-v2/service/ssm v1.55.1 // indirect
