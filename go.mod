module github.com/asia-loop-gmbh/asia-loop-utils-go/v8
...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/cognitoidentityprovider v1.25.2
	github.com/aws/aws-sdk-go-v2/service/sns v1.21.3
	github.com/nam-truong-le/lambda-utils-go/v4 v4.1.50
...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/secretsmanager v1.21.1 // indirect
