...
require (
	...
	github.com/nam-truong-le/lambda-utils-go/v4 v4.1.266
...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/secretsmanager v1.29.2 // indirect
	github.com/aws/aws-sdk-go-v2/service/ssm v1.50.5 // indirect
