...
require (
	...
	github.com/nam-truong-le/lambda-utils-go/v4 v4.1.236
...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/secretsmanager v1.28.0 // indirect
	github.com/aws/aws-sdk-go-v2/service/ssm v1.49.0 // indirect
